    ...
    <section class="sectionInscription">
        <div>
            <form method="post" enctype="multipart/form-data" class="form">
                ...
                <input type="number" id="prix" name="prix" class="inputform" ><br>
                ...
                <input type="text" id="couleur" name="couleur"  class="inputform"><br>

                <label for="systemeexploitation" class="labeform">Système d'exploitation:</label>
                <input type="text" id="systemeexploitation" name="systemeexploitation"  class="inputform"><br>

                <label for="ram" class="labeform">RAM:</label>
                <input type="text" id="ram" name="ram"  class="inputform"><br>

                <label for="memoire" class="labeform">Mémoire interne:</label>
                <input type="text" id="memoire" name="memoire"  class="inputform"><br>

                <label for="paysfabrication" class="labeform">Pays de fabrication:</label>
                <input type="text" id="paysfabrication" name="paysfabrication"  class="inputform"><br>

                <label for="description" class="labeform">Description:</label>
                <textarea name="description" id="description"  class="inputform"></textarea><br>

                <label for="quantite" class="labeform">Quantité:</label>
                <input type="number" id="quantite" name="quantite"  class="inputform"><br>
